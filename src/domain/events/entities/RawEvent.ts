...
// Core aggregate root — represents an incoming webhook payload before validation
...
export class RawEvent {
  private constructor(
    public readonly id: string, // idempotency key
  ...
  static reconstitute(data: {
    ...
    return new RawEvent(
      ...
      data.healingAttempts,
      data.errorLog,
      data.transformationRuleId,
      data.createdAt,
      data.updatedAt
    );
  }
  ...
  get validatedPayload(): unknown | null {
    return this._validatedPayload;
  }

  get healingAttempts(): number {
    return this._healingAttempts;
  }

  get errorLog(): ReadonlyArray<string> {
    return this._errorLog;
  }

  get transformationRuleId(): string | null {
    return this._transformationRuleId;
  }
