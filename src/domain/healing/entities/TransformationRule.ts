...
// Represents a learned fix — the AI-generated transformation script
...
export class TransformationRule {
  private constructor(
    ...
    public readonly errorFingerprint: string, // hash of schema + error type
    ...
    public readonly generatedBy: string, // LLM model used
  ...
  get successRate(): number {
    ...
    if (total === 0) return 0;
    return this._successCount / total;
  }
  ...
  recordSuccess(): void {
    ...
    // Auto-quarantine rules with very low success rate after enough attempts
